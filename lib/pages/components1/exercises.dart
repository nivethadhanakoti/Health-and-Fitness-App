  ...
  final List<Map<String, dynamic>> _workouts = [
    {
      ...
      'exercises': [{'name': 'Push-ups-10', 'done': false},
        {'name': 'Sit ups-10', 'done': false},],
    },
    {
      'day': 2,
      'exercises': [{'name': 'Push-ups-10', 'done': false},
        {'name': 'Planks-3 sets of 1 min each', 'done': false},],
    },
    {
      'day': 1,
      'exercises': [
    ...
    {
      'day': 4,
      'exercises': [{'name': 'Planks-3 sets of 1 min each', 'done': false},
    ...
    },
    {
      'day': 6,
      'exercises': [{'name': 'Push-ups-10', 'done': false},
        {'name': 'Russian twist-20', 'done': false},],
    },
    {
      'day': 7,
    ...
    },
    {
      'day': 12,
      'exercises': [{'name': 'Push-ups-20', 'done': false},
        {'name': 'Planks-5 sets of 1 min each', 'done': false},],
    },
    {
      'day': 13,
      'exercises': [{'name': 'Push-ups-20', 'done': false},
        {'name': 'Jumping jacks-30', 'done': false},],
    },
    {
      'day': 14,
      'exercises': [{'name': 'Planks-5 sets of 1 min each', 'done': false},
        {'name': 'Squats-30', 'done': false},],
    },
    {
      'day': 15,
      'exercises': [{'name': 'Lounges-30 each side', 'done': false},
    ...
    {
      'day': 17,
      'exercises': [{'name': 'Push-ups-30', 'done': false},
        {'name': 'Hollow hold-30 counts', 'done': false},],
    },
    {
      'day': 18,
      'exercises': [{'name': 'Bicycle crunch-30', 'done': false},
        {'name': 'Planks-5 sets of 1 min each', 'done': false},],
    },
    {
      'day': 19,
    ...
    {
      'day': 20,
      'exercises': [{'name': 'Dead bug-30 counts', 'done': false},
        {'name': 'Bicycle crunch-20', 'done': false},],
    },
    {
      'day': 21,
      'exercises': [{'name': 'Push-ups-30', 'done': false},
        {'name': 'Sit ups-30', 'done': false},],
    },
    {
      'day': 22,
      'exercises': [{'name': 'Push-ups-30', 'done': false},
        {'name': 'Planks-7 sets of 1 min each', 'done': false},],
    },
    {
      'day': 23,
      'exercises': [{'name': 'Push-ups-30', 'done': false},
    ...
    {
      'day': 24,
      'exercises': [{'name': 'Planks-7 sets of 1 min each', 'done': false},
        {'name': 'Squats-40', 'done': false},],
    },
    {
      'day': 25,
      'exercises': [{'name': 'Lounges-40 each side', 'done': false},
        {'name': 'Wall push ups-30', 'done': false},],
    },
    {
      'day': 26,
      'exercises': [{'name': 'Push-ups-30', 'done': false},
        {'name': 'Russian twist-40', 'done': false},],
    },
    {
      'day': 27,
      'exercises': [{'name': 'Push-ups-40', 'done': false},
        {'name': 'Hollow hold-40 counts', 'done': false},],
    },
    {
      'day': 28,
      'exercises': [{'name': 'Bicycle crunch-40', 'done': false},
        {'name': 'Planks-7 sets of 1 min each', 'done': false},],
    },
    {
      'day': 29,
    ...
    {
      'day': 30,
      'exercises': [{'name': 'Dead bug-40 counts', 'done': false},
        {'name': 'Bicycle crunch-30', 'done': false},],
    },
  ];
